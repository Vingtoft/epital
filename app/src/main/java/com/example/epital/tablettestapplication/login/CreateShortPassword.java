...
public class CreateShortPassword extends Fragment implements View.OnClickListener {
    ...
    private void init() {
        ...
        ImageButton opret_bruger = (ImageButton) getActivity().findViewById(R.id.btn_round_opret_bruger);
        ((ViewManager)opret_bruger.getParent()).removeView(opret_bruger);
        ImageButton help = (ImageButton) getActivity().findViewById(R.id.btn_round_hjaelp);
        ((ViewManager)help.getParent()).removeView(help);
        //init all variables
        overskrift = (TextView) getActivity().findViewById(R.id.logintekst);

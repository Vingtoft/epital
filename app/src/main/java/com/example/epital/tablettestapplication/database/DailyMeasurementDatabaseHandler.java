...
public class DailyMeasurementDatabaseHandler {
    ...
    public static final String TABLE_CREATE =
            "CREATE TABLE " + TABLE_NAME + " ("+OXYGEN+" INT, "+PULSE+" INT, "+FEV1+" FLOAT, "+Q1+" BOOLEAN, "+Q2+" BOOLEAN, "+Q3+"BOOLEAN);";
    ...
    public long insertCompleteDailyMeasurement(int oxygen, int pulse, double fev1, boolean q1, boolean q2, boolean q3){
